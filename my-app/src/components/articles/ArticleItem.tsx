...
const ArticleItem = ({article}:ArticleItemProps) => {
  return (
    <div className="p-5 rounded-lg my-1 shadow-lg border-2 border-gray-400 hover:bg-slate-200 w-fulll md:w-2/5 lg:w-1/4 ">
    <h1 className="text-xl font-bold text-gray-900 line-clamp-1" key={article.id}>{article.title}</h1>
